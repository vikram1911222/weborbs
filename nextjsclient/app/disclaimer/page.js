...
export default function Disclaimer() {
    return (
        <div className="max-w-5xl mx-auto px-6 mt-16 py-12 font-sans text-gray-800 antialiased leading-relaxed">
            {/* Main Title */}
            ...
            <div className="space-y-8 text-[15px]">
                ...
                <section>
                    ...
                    <p className="mb-4">
                        The information provided by vooklu ("we," "us," or "our") on{' '}
                        <a
                            href="http://www.vooklu.com"
                            target="_blank"
                ...
                <section className="space-y-4">
                    ...
                    <p>
                        ...
                        claim, and you should not assume, that all users will have the same experiences. YOUR INDIVIDUAL RESULTS
                        MAY VARY.
                    </p>
                    <p>
                        The testimonials on the Site are submitted in various forms such as text, audio and/or video, and are reviewed
                        by us before being posted. They appear on the Site verbatim as given by the users, except for the correction of
